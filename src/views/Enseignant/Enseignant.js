...
import RepondreSujet from './RepondreSujet';
import './Enseignant.css'
const { Title } = Typography;
const { Content, Sider } = Layout;
const Tabs = [
	{
		nom: "Repondre a un sujet",
		link: "messages/repondre",
		View: RepondreSujet,
		title: <>Repondre a un sujet</>,
		icon: faEdit
	},
	{
		nom: "Sujet Actif",
	...
	},
	{
		...
		link: "parametres",
		View: SujetActif,
		title: <>Parametre cours</>,
		icon: faBookReader
	}
]

export const Enseignant = ({ current }) => {
